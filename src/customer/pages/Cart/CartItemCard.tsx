...
//     updateCartItem({
//       jwt,
//       cartitemId: item._id, // ✅ EXACT MATCH
//       quantity,
//     })
    
//   ).then(() => {
//     dispatch(fetchCart(jwt)); // ✅ refresh totals
//   });
// };
...
//           <span className="px-3 font-semibold text-[#4A1F2A]">{item.quantity}</span>
...
//         {/* PRICE */}
//         <div>
//           <p className="font-semibold text-[#4A1F2A] text-lg">₹{item.product.sellingPrice * item.quantity}</p>
//         </div>
//       </div>
