...
//       <h1 className="text-xl font-semibold text-[#2B1B12] mb-4">
//         All Products
//       </h1>

//       <div className="overflow-x-auto rounded-xl border border-[#E8D9C5]">
//         <table className="min-w-full border-collapse">
//           {/* ===== HEADER ===== */}
//           <thead>
//             <tr className="bg-[#2B1B12] text-[#F5EBDD] text-sm">
...
//                   {/* Title */}
//                   <td className="px-4 py-4 text-sm text-[#2B1B12] font-medium">
//                     {product.title}
//                   </td>
...
//                     <button className="p-2 rounded-lg hover:bg-[#F5EBDD] transition">
//                       <Edit />
//                     </button>
//                   </td>
//                 </tr>
